...
const TestimonialSection = () => {
  return (
	<div className='pb-14 px-8 md:px-0'>
	  ...
	  <p className='md:text-base text-gray-500 mt-3'>Here from our learners as they share their journeys of transformation , sucess,and how our <br/> platform has made a difference in their lives</p>
